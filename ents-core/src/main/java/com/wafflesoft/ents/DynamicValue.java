...
public interface DynamicValue<T> {
     ...
     *
     * @param e The entity to compute a value for.
     ...
     * @param value The value that modifies the state of the entity.
     */
     ...
     *
     * @param e      The entity to compute a value for.
     * @param target The value to set to the computed value.
