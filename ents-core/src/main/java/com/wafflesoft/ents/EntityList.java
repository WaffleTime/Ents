...
public class EntityList extends Entity {
     ...
     *
     * @param initialCapacity The initial capacity of this EntityList. This represents the
     ...
     * and enabled from this EntityList.
     *
     * @param entities The initial set of entities in this EntityList.
     * @see Entity#Entity()
     */
     ...
     *
     * @param template The template of the EntityList.
     * @param entities The initial set of entities in this EntityList.
     ...
     *
     * @param template The template of the clone.
     * @param values   The values of the clone.
     * @param renderer The renderer of the clone.
     */
     ...
     *
     * @param e     The entity added to this EntityList.
     * @param index The index of the entity (and the current size of the list before
     *              the addition).
     */
     ...
     * @param index The index of the entity removed in the backing array.
     */
     ...
     * @param index       The index of the entity in the backing array.
     * @param updateState The updateState passed from {@link #update(Object)}.
     */
     ...
     * number of entities.
     *
     * @param count The number of entities about to be added to this EntityList.
     */
     ...
     * in.
     *
     * @param entity The entity to add to this EntityList.
     */
     ...
     *
     * @param entityArray The array of entities to add.
     */
     ...
     *
     * @param entityArray The array of entities to take from.
     * @param from        The index of the first entity to be taken (inclusive).
     * @param to          The index of the last entity to be taken (exclusive).
     */
     ...
     *
     * @param list The EntityList to add to this EntityList.
     */
     ...
     *
     * @param entityCollection The collection to take entities from to add to this EntityList.
     */
     ...
     *
     * @param delete True if {@link Entity#delete()} should be invoked on all entities
     *               in this EntityList.
     */
     ...
     *
     * @param inheritVisible True if the visibility of the child entities is inherited.
     */
     ...
     *
     * @param inheritEnabled True if the enabled of the child entities is inherited.
     */
