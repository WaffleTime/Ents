...
import com.wafflesoft.ents.util.IndexPool;
...
public class Ents {
     ...
     *
     * @param name            The name of the view.
     * @param defaultRenderer The default {@link Renderer} of the view.
     * @return The reference to the newly created view.
     */
     ...
     *
     * @param view            The view to set the default renderer of.
     * @param defaultRenderer The default renderer of the specified view definition.
     */
     ...
     *
     * @param view     A view to create an alternative for (could be the definition or
     *                 another alternative).
     * @param renderer The renderer of the alternative view.
     * @return The reference to the newly created view.
     */
     ...
     *
     * @param definition Whether or not the view was a view definition or an alternative
     *                   view.
     * @param view       The view added.
     ...
     *
     * @param name           The name of the controller.
     * @param defaultControl The default {@link Control} of the controller.
     * @return The reference to the newly created controller.
     */
     ...
     *
     * @param controller     The controller to set the default control of.
     * @param defaultControl The default control of the specified controller definition.
     */
     ...
     *
     * @param controller The controller to create an alternative for (could be the
     *                   definition or another alternative).
     * @param control    The control of the alternative controller.
     * @return
     */
     ...
     *
     * @param definition Whether or not the controller was a controller definition or an
     *                   alternative controller.
     * @param controller The controller added.
     ...
     *
     * @param name    The name of the component.
     * @param factory The factory for creating default values, aid in cloning, and
     ...
     *
     * @param component The component to create an alternative for (could be the
     *                  definition or another alternative).
     * @param factory   The factory for creating default values, aid in cloning, and
     *                  copying one value to another.
     * @return The reference to the newly created component.
     ...
     *
     * @param name    The name of the component.
     * @param dynamic The {@link DynamicValue} implementation for the component.
     * @return The reference to the newly created component.
     ...
     *
     * @param name     The name of the component.
     * @param constant The global value shared between all entities.
     * @param settable True if {@link Entity#set(Component, Object)} or
     ...
     *
     * @param custom The custom component definition to add.
     ...
     *
     * @param name    The name of the component.
     * @param factory The {@link ComponentFactory} which creates component
     ...
     * @param componentSet  The components to add to the template.
     * @param controllerSet The controllers to add to the template.
     * @param view          The view of the template.
     ...
     *
     * @param name       The name of the template.
     * @param components The components to add to the template.
     * @return The reference to the newly created template.
     */
     ...
     * the template.
     *
     * @param base          The template to extend.
     * @param name          The name of the new template.
     * @param componentSet  The components to ensure existence on the new template.
     * @param controllerSet The controllers to ensure existence on the new template.
     * @param view          The view to set to the new template (if non-null).
     * @return The reference to the newly created Template.
     */
     ...
     * @param base       The template to extend.
     * @param name       The name of the new template.
     * @param components The components to ensure existence on the new template.
     * @return The reference to the newly created Template.
     */
     ...
     *
     * @param name             The name of the new template.
     * @param overwrite        Whether or not components that already exist on the new template
     *                         should be overwritten while merging templates into it.
     * @param templatesToMerge The templates to merge together to create a new template. The new
     ...
     *
     * @param template The template added.
     ...
     *
     * @param listener The EntityListener to notify of all events.
     */
