...
public class EntityChain extends Entity {
     ...
     *
     * @param template The template of the EntityChain.
     ...
     *
     * @param first          The first Entity in the chain.
     * @param last           The last (third) Entity in the chain.
     * @param inheritVisible True if the visibility of the first and last entities is
     *                       inherited.
     * @param inheritEnabled True if the enabled of the first and last entities is inherited.
     * @see Entity#Entity()
     * @see #setInheritEnabled(boolean)
     * @see #setInheritVisible(boolean)
     */
     ...
     *
     * @param last The last Entity in the chain.
     */
