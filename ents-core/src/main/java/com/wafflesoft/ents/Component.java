...
public abstract class Component<T> extends Id {
     ...
     *
     * @param template The template to add a component to.
     ...
     *
     * @param e                 The entity that has just had this component added to it.
     * @param template          The template adding this component to the given entity.
     * @param templateComponent The TemplateComponent created by the {@link #add(Template)}
     *                          method.
     */
