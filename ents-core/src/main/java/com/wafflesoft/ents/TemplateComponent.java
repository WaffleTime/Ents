...
public interface TemplateComponent<T> {
     ...
     *
     * @param e     The entity to set the value to.
     ...
     *
     * @param e The entity to get the value from.
     ...
     *
     * @param e      The entity to take from.
     * @param target The target value to set and return.
     ...
     *
     * @param template The template to remove this TemplateComponent from.
     */
     ...
     * of its components.
     *
     * @param e The entity that just had this component added to it.
     */
     ...
     *
     * @param e The entity that is having this component be removed.
     */
