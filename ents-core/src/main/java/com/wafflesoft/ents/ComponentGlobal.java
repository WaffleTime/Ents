...
class ComponentGlobal<T> extends Component<T> {
     ...
     * @param constant The constant shared between all Entities that have this component.
     * @param settable Whether or not the constant can be changed when set is called on
     *                 an
