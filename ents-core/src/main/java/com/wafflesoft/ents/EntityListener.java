...
public interface EntityListener {
     ...
     *
     * @param e  The entity added to the system.
     ...
     *
     * @param e The entity removed from the system.
     */
     ...
     * @param definition Whether this view was a definition or an instance (alternative).
     */
     ...
     * @param definition Whether this controller was a definition or an instance
     *                   (alternative).
     */
     ...
     * @param definition Whether this component was a definition or an instance
     *                   (alternative).
     */
