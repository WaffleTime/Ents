...
public class EntityLayers extends Entity {
     ...
     *
     * @param enumClass The enum that will be used for accessing layers.
     */
     ...
     *
     * @param template  The template of the EntityLayers.
     * @param enumClass The enum that will be used for accessing layers.
     */
     ...
     * @param layerCount The number of layers in the clone.
     */
     ...
     *
     * @param enumConstant The enum that will be used for accessing layers.
     ...
     *
     * @param layerIndex The enum that will be used for accessing layers.
     * @param e          The entity to add.
     */
     ...
     *
     * @param i The index of the first layer.
     * @param j The index of the second layer.
     */
     ...
     *
     * @param i The enum of the first layer.
     * @param j The enum of the second layer.
     */
