...
public class EntityUtility {
     ...
     *
     * @param ids The {@link Id}s to search through.
     ...
     *
     * @param ids The array of {@link Id}s to create a map from.
     ...
     * true.
     *
     * @param a The first object to check for equality.
     * @param b The second object to check for equality.
